...
# libsmb2 links Winsock in its CMake target but omits it from the generated
# pkg-config metadata. FFmpeg's static configure probe must receive the same
# transitive dependency.
if(VCPKG_TARGET_IS_WINDOWS)
    foreach(LIBSMB2_PC IN ITEMS
        "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libsmb2.pc"
        "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libsmb2.pc"
    )
        if(EXISTS "${LIBSMB2_PC}")
            file(APPEND "${LIBSMB2_PC}" "\nLibs.private: -lws2_32\n")
        endif()
    endforeach()
endif()
...
file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/vcpkg-cmake-wrapper.cmake"
    DESTINATION "${CURRENT_PACKAGES_DIR}/share/smb2")
